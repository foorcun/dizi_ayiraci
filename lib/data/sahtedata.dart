    ...
    "sezons": [
      {
        "sezonAdi": "1. sezon",
        "episodes": [
          {"bölümAdi": "Attack on Titan sezon 1 bölüm 1"},
          {"bölümAdi": "Attack on Titan sezon 1 bölüm 1"},
        ]
      },
      {
...
//       "sezonAdi": "1. sezon",
//       "episodes": {
//         {"bölümAdi": "Dizi 2 sezon 1 bölüm 1"},
//         {"bölümAdi": "Dizi 2 sezon 1 bölüm 1"},
//         {"bölümAdi": ""},
//         {"bölümAdi": ""},
//         {"bölümAdi": "Dizi 2 sezon 1 bölüm 1"},
...
const sahteString0 = '''[
  ...
  "fotoLink":"https://upload.wikimedia.org/wikipedia/en/d/d6/Shingeki_no_Kyojin_manga_volume_1.jpg","sezonSayisi": 4,
    "sezons": [
      {"sezonAdi": "1. sezon","episodes":[ {"episodeName": "Attack on Titan sezon 1 bölüm 1"}]},
        {"sezonAdi": "2. sezon","episodes": [{"episodeName": "Attack on Titan sezon 1 bölüm 1"}]}
        ]
        }
        ]''';
